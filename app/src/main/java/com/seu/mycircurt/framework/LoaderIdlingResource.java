 ...
 */
package com.seu.mycircurt.framework;
...
public class LoaderIdlingResource implements IdlingResource {
     ...
     * {@link LoaderManager.LoaderCallbacks#onCreateLoader(int, android.os.Bundle)}.
     */
     ...
     * {@link LoaderManager.LoaderCallbacks#onLoadFinished(Loader, Object)}
     * and {@link LoaderManager.LoaderCallbacks#onLoaderReset(Loader)}.
     */
