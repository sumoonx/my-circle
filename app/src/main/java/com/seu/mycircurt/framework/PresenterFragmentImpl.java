...
import com.seu.mycircurt.util.ThrottledContentObserver;
...
import static com.seu.mycircurt.util.LogUtils.LOGE;
 ...
 * Custom Presenters can extend this. It uses a non-UI {@link Fragment} to participate
 * in the {@link Activity} lifecycle.
 * <p/>
...
public class PresenterFragmentImpl extends Fragment
    ...
    /**
     * Key to be used in Bundle passed in {@link #onUserAction(UserActionEnum, Bundle)}
    ...
    /**
     * The queries to load when the {@link Activity} loading this
     * {@link Fragment} is created.
     */
